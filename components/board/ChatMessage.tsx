        ...
        if (part.type === 'cardMention') {
          return (
            <button
              ...
              className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded bg-violet-100 dark:bg-violet-900/40 text-violet-700 dark:text-violet-300 text-xs font-medium hover:bg-violet-200 dark:hover:bg-violet-800/60 transition-colors cursor-pointer underline-offset-2 hover:underline"
            >
              #&thinsp;{part.name}
            </button>
          );
