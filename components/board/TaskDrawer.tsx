        ...
        <div className="flex-shrink-0 px-4 py-2 border-b border-neutral-100 dark:border-neutral-800 flex items-center gap-3">
          ...
          <div className="flex items-center">
            ...
            {currentDueDate ? (() => {
              ...
              const colorClass = currentStatus === 'done'
              ...
              return (
                <span className={`inline-flex items-center gap-1 pl-2 pr-1 py-0.5 rounded-full text-xs font-medium ${colorClass}`}>
                  <button
                  ...
                  <button
                    ...
                    className="w-4 h-4 flex items-center justify-center rounded-full hover:bg-black/10 dark:hover:bg-white/10 transition-colors"
