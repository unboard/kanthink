...
export const MCS_SEED: SeedIdea[] = [
  // ---------------- JANUARY — fresh start, tax + spring pre-season ----------------
  {
    ...
    metric: 'Design generations started · Pro upgrades', owner: 'Dustin', collaborators: ['Eric'],
  ...
  },
  {
    ...
    metric: 'Organic sessions · assisted print orders', owner: 'Dustin', collaborators: ['Eric'],
  ...
  },
  {
    ...
    metric: 'Signups + Pro conversions per $ · CAC', owner: 'Dustin', collaborators: ['Eric'],
    tools: ['Google Ads', '/design', '/for pages'], effort: 'M', status: 'done',
    notes: 'Land on the product /design flow, not the homepage. Eric wires conversion tracking to Pro upgrade + first order.',
  },
  {
  ...
  },
  {
    ...
    metric: 'Sends shipped per week · marketing hours saved', owner: 'Eric', collaborators: ['Dustin'],
    tools: ['Customer.io', 'React Email'], effort: 'L', status: 'done',
    notes: 'Map CIO industry attributes → template slugs. Dustin supplies the seasonal calendar; Eric automates the trigger + assembly.',
  },
  {
  ...
  },
  {
    ...
    metric: 'Organic sessions · repeat orders', owner: 'Dustin', collaborators: ['Eric'],
    tools: ['Blog CMS', 'SEO', 'Customer.io'], effort: 'M', status: 'done',
    notes: 'Gate a printable calendar PDF for email capture. Eric turns it into an evergreen onboarding drip.',
  },
  {
    ...
    metric: 'Pro upgrades · print orders from retargeting', owner: 'Eric', collaborators: ['Dustin'],
  ...
  },
  {
    ...
    metric: 'Organic sessions · bundle orders', owner: 'Dustin', collaborators: ['Eric'],
    tools: ['Blog CMS', 'SEO', '/design'], effort: 'S', status: 'done',
  ...
  },
  {
    ...
    metric: 'Weekly send cadence held · segment engagement', owner: 'Eric', collaborators: ['Dustin'],
    tools: ['Customer.io', 'React Email'], effort: 'L', status: 'done',
  ...
  },
  {
    ...
    metric: 'AI referral sessions · /for impressions', owner: 'Eric', collaborators: ['Dustin'],
  ...
  },
  {
    ...
    metric: 'Segment engagement · Q4 print orders', owner: 'Dustin', collaborators: ['Eric'],
  ...
  },
  {
    ...
    metric: 'Political orders per $ · ROAS', owner: 'Dustin', collaborators: ['Eric'],
    tools: ['Google Ads', '/for pages', '/design'], effort: 'M', status: 'planned',
    notes: 'Land on the political /for page. Eric tracks order value for ROAS. Emphasize turnaround time in ad copy.',
  },
  {
  ...
  },
  {
    ...
    metric: 'Organic sessions · Q4 orders', owner: 'Eric', collaborators: ['Dustin'],
    tools: ['Blog CMS', 'React Email', 'SEO'], effort: 'M', status: 'planned',
    notes: 'Eric auto-drafts from product data + calendar; Dustin edits for voice. Repurpose to a Customer.io drip.',
  },
  {
  ...
  },
  {
    ...
    metric: 'Political orders · AOV', owner: 'Dustin', collaborators: ['Eric'],
    tools: ['Customer.io', 'EDDM tool', '/design'], effort: 'S', status: 'planned',
  ...
  },
  {
    ...
    metric: 'Pro / Unlimited upgrades · MRR', owner: 'Eric', collaborators: ['Dustin'],
  ...
  },
  {
    ...
    metric: 'Pro upgrades · MRR', owner: 'Jason', collaborators: ['Eric'],
    tools: ['Editor', '/design'], effort: 'M', status: 'planned',
    notes: 'Countdown banner, discounted annual Pro, one-click upgrade. Eric wires the eligibility + tracking.',
  },
  {
    ...
    metric: 'Pro / Unlimited upgrades · MRR', owner: 'Dustin', collaborators: ['Eric'],
  ...
  },
  {
    ...
    metric: 'Organic sessions · seasonal orders', owner: 'Dustin', collaborators: ['Eric'],
    tools: ['Blog CMS', 'SEO', '/design'], effort: 'S', status: 'planned',
  ...
  },
  {
    ...
    metric: 'Planning hours saved · calendar coverage', owner: 'Eric', collaborators: ['Dustin'],
  ...
  },
  {
    ...
    metric: 'January engagement · design generations', owner: 'Dustin', collaborators: ['Eric'],
