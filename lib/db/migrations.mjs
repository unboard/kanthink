...
export const CREATE_TABLE_STATEMENTS = [
  ...
  // Migration 0038 — build shrooms remember which preset to generate with
  `ALTER TABLE instruction_cards ADD playground_preset_id text`,
  // Migration 0037 — playground presets (design profile / recipe / runtime deps)
...
export const INDEX_STATEMENTS = [
  ...
  // Migration 0037 indexes
  `CREATE INDEX IF NOT EXISTS playground_presets_user_idx ON playground_presets (user_id)`,
  `CREATE INDEX IF NOT EXISTS playground_presets_scope_idx ON playground_presets (scope)`,
]
