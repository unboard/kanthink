...
// Web search is now handled via OpenAI Responses API in the provider
// This function is kept for backwards compatibility but returns empty
// The actual search happens in lib/ai/providers/openai.ts
export async function webSearch(_query: string, _maxResults: number = 5): Promise<SearchResult[]> {
  // Search is handled by OpenAI Responses API directly
  return [];
}
